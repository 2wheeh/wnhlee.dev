---
author: wonhee
pubDatetime: 2024-06-01T00:30:47.000+09:00
modDatetime:
...
export const CurrentState = () => (
  <span class="font-bold text-green-700">current state</span>
);

export const PendingState = () => (
  <span class="font-bold text-orange-700">pending state</span>
);

export const UpdateFunction = () => (
  <span class="font-bold text-blue-700">update function</span>
);
